...
var proto_utils_pb = require('../proto/utils_pb.js');
goog.object.extend(proto, proto_utils_pb);
goog.exportSymbol('proto.family_tree.FamilyMember', null, global);
goog.exportSymbol('proto.family_tree.FamilyTree', null, global);
goog.exportSymbol('proto.family_tree.FamilyUnit', null, global);
goog.exportSymbol('proto.family_tree.Relationships', null, global);
/**
 ...
 * @constructor
 */
proto.family_tree.Relationships = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.family_tree.Relationships.repeatedFields_, null);
};
goog.inherits(proto.family_tree.Relationships, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.family_tree.Relationships.displayName = 'proto.family_tree.Relationships';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.family_tree.FamilyMember.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    dateOfBirth: (f = msg.getDateOfBirth()) && proto_utils_pb.GregorianDate.toObject(includeInstance, f),
    traditionalDateOfBirth: (f = msg.getTraditionalDateOfBirth()) && proto_utils_pb.TraditionalDate.toObject(includeInstance, f),
...
proto.family_tree.FamilyMember.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      reader.readMessage(value,proto_utils_pb.GregorianDate.deserializeBinaryFromReader);
      msg.setDateOfBirth(value);
      break;
    case 5:
      var value = new proto_utils_pb.TraditionalDate;
      reader.readMessage(value,proto_utils_pb.TraditionalDate.deserializeBinaryFromReader);
...
proto.family_tree.FamilyMember.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      4,
      f,
      proto_utils_pb.GregorianDate.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      5,
      f,
      proto_utils_pb.TraditionalDate.serializeBinaryToWriter
    );
  }
...
proto.family_tree.FamilyMember.prototype.getDateOfBirth = function() {
  return /** @type{?proto.utils.GregorianDate} */ (
    jspb.Message.getWrapperField(this, proto_utils_pb.GregorianDate, 4));
};
...
proto.family_tree.FamilyMember.prototype.getTraditionalDateOfBirth = function() {
  return /** @type{?proto.utils.TraditionalDate} */ (
    jspb.Message.getWrapperField(this, proto_utils_pb.TraditionalDate, 5));
};
...
proto.family_tree.FamilyMember.prototype.getDateOfDeath = function() {
  return /** @type{?proto.utils.GregorianDate} */ (
    jspb.Message.getWrapperField(this, proto_utils_pb.GregorianDate, 7));
};
...
proto.family_tree.FamilyMember.prototype.getTraditionalDateOfDeath = function() {
  return /** @type{?proto.utils.TraditionalDate} */ (
    jspb.Message.getWrapperField(this, proto_utils_pb.TraditionalDate, 8));
};
...
proto.family_tree.FamilyMember.prototype.getWeddingDate = function() {
  return /** @type{?proto.utils.GregorianDate} */ (
    jspb.Message.getWrapperField(this, proto_utils_pb.GregorianDate, 12));
};
 ...
 * @const
 */
proto.family_tree.Relationships.repeatedFields_ = [1,2,3];
 ...
 * @return {!Object}
 */
proto.family_tree.Relationships.prototype.toObject = function(opt_includeInstance) {
  return proto.family_tree.Relationships.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.family_tree.Relationships} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.family_tree.Relationships.toObject = function(includeInstance, msg) {
  var f, obj = {
    childrenIdsList: (f = jspb.Message.getRepeatedField(msg, 1)) == null ? undefined : f,
    spouseIdsList: (f = jspb.Message.getRepeatedField(msg, 2)) == null ? undefined : f,
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.family_tree.Relationships}
 */
proto.family_tree.Relationships.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.family_tree.Relationships;
  return proto.family_tree.Relationships.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.family_tree.Relationships} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.family_tree.Relationships}
 */
proto.family_tree.Relationships.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.family_tree.Relationships.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.family_tree.Relationships.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.family_tree.Relationships} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.family_tree.Relationships.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!Array<string>}
 */
proto.family_tree.Relationships.prototype.getChildrenIdsList = function() {
...
/**
 * @param {!Array<string>} value
 * @return {!proto.family_tree.Relationships} returns this
 */
proto.family_tree.Relationships.prototype.setChildrenIdsList = function(value) {
 ...
 * @return {!proto.family_tree.Relationships} returns this
 */
proto.family_tree.Relationships.prototype.addChildrenIds = function(value, opt_index) {
 ...
 * @return {!proto.family_tree.Relationships} returns this
 */
proto.family_tree.Relationships.prototype.clearChildrenIdsList = function() {
 ...
 * @return {!Array<string>}
 */
proto.family_tree.Relationships.prototype.getSpouseIdsList = function() {
 ...
 * @return {!proto.family_tree.Relationships} returns this
 */
proto.family_tree.Relationships.prototype.setSpouseIdsList = function(value) {
 ...
 * @return {!proto.family_tree.Relationships} returns this
 */
proto.family_tree.Relationships.prototype.addSpouseIds = function(value, opt_index) {
 ...
 * @return {!proto.family_tree.Relationships} returns this
 */
proto.family_tree.Relationships.prototype.clearSpouseIdsList = function() {
  return this.setSpouseIdsList([]);
};
 ...
 * @return {!Array<string>}
 */
proto.family_tree.Relationships.prototype.getParentIdsList = function() {
  return /** @type {!Array<string>} */ (jspb.Message.getRepeatedField(this, 3));
};
 ...
 * @return {!proto.family_tree.Relationships} returns this
 */
proto.family_tree.Relationships.prototype.setParentIdsList = function(value) {
  return jspb.Message.setField(this, 3, value || []);
};
 ...
 * @return {!proto.family_tree.Relationships} returns this
 */
proto.family_tree.Relationships.prototype.addParentIds = function(value, opt_index) {
  return jspb.Message.addToRepeatedField(this, 3, value, opt_index);
};
 ...
 * @return {!proto.family_tree.Relationships} returns this
 */
proto.family_tree.Relationships.prototype.clearParentIdsList = function() {
